...
main(int argc, char* argv[])
{
    ...
    std::string queueDisc = "PifoQueueDisc"; // FifoQueueDisc
    ...
    Config::SetDefault(queueDisc + "::MaxSize", QueueSizeValue(QueueSize("1000p")));
    ...
    sender.Get(1)->SetWeight(1);
    ApplicationContainer sourceApps1 = source.Install(sender.Get(0));
    ...
    sender.Get(1)->SetWeight(10);
    ApplicationContainer sourceApps2 = source.Install(sender.Get(1));

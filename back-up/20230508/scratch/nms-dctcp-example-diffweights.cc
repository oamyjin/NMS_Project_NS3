...
main(int argc, char* argv[])
{
    ...
    pointToPointT.SetDeviceAttribute("DataRate", StringValue("1Gbps"));//10Gbps
    ...
    Config::SetDefault(qdiscTypeId + "::MaxSize", QueueSizeValue(QueueSize("2666p"))); // 2666p / 8 = 333.25 = 334
    ...
    tchRed10.SetRootQueueDisc("ns3::RedQueueDisc",
                              ...
                              "MaxTh",
                              DoubleValue(150)); //150
    // tchRed10.SetRootQueueDisc(qdiscTypeId, //PifoQueueDisc
    //                             "MinTh", 
    //                             DoubleValue(100),
    //                             "UseEcn",
    //                             BooleanValue(true));
    //std::cout << T1T2.Get(0) << " " << T1T2.Get(1) << std::endl;
    ...
    tchRed1.SetRootQueueDisc("ns3::RedQueueDisc",
                             ...
                             "MaxTh",
                             DoubleValue(60));//60
    //std::cout << R1T2.Get(1) << " " << R1T2.Get(0) << std::endl;
    // tchRed1.SetRootQueueDisc(qdiscTypeId, //PifoQueueDisc 
    //                             "MinTh", 
    //                             DoubleValue(40),
    //                             "UseEcn",
    //                             BooleanValue(true));

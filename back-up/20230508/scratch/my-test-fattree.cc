...
main(int argc, char* argv[])
{
    ...
    char line[200];
	flowf.open("scratch/traffic.txt"); //traffic_3.txt //traffic_5.txt //traffic_7.txt //traffic_9.txt //flow_test.txt
	flowf.getline(line, 100);
    ...
    Config::SetDefault ("ns3::TcpSocket::DelAckTimeout", TimeValue(Seconds (0.00002412)));//000600 //0.00002412 //delayed ack time out default is 200ms
    //Config::SetDefault("ns3::TcpSocket::DelAckCount", UintegerValue(2));
    Config::SetDefault ("ns3::RttEstimator::InitialEstimation", TimeValue(Seconds (0.00000804)));// 0000132 //0.00000804 RTT(Propgation delay) = 2*(0.01+1+1+1+1+0.01) = 8.04us
    Config::SetDefault ("ns3::TcpSocketBase::MinRto", TimeValue(Seconds (0.0000402))); // 0000660 // 0.0000402 5RTT = 5*8.04 = 40.2us
    Config::SetDefault ("ns3::TcpSocket::ConnTimeout", TimeValue(Seconds (0.0000402))); // 0000660 // 0.0000402 syn timeout 5rtt
    ...
    //tch.SetRootQueueDisc ("ns3::PifoQueueDisc", "MaxSize", StringValue("1000p"));
    //tch.SetRootQueueDisc ("ns3::AFQQueueDisc");
    //tch.SetRootQueueDisc("ns3::FifoQueueDisc", "MaxSize", StringValue("10000p"));

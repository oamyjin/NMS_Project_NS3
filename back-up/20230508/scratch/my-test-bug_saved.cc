...
const char* Node2Tor_Delay = "30us"; //10ns
...
const char* AppDataRate = "100Gbps";  // 10Gbps
...
main(int argc, char* argv[])
{
    ...
    //Config::SetDefault ("ns3::RttEstimator::InitialEstimation", TimeValue(Seconds (0.0000012)));// 0000132 //0.00000804 RTT(Propgation delay) = 2*(0.01+1+1+1+1+0.01) = 8.04us
    //Config::SetDefault ("ns3::TcpSocketBase::MinRto", TimeValue(Seconds (0.0000060))); // 0000660 // 0.0000402 5RTT = 5*8.04 = 40.2us
    //Config::SetDefault ("ns3::TcpSocket::ConnTimeout", TimeValue(Seconds (0.0000060))); // 0000660 // 0.0000402 syn timeout 5rtt
    ...
    tch.Install(podDev[0][20].Get(0)); //server21-tor, on the tor side

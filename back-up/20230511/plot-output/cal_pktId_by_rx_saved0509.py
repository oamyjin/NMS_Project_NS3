...
if __name__ == "__main__":
    period = 0.1
    # sche = ['MyResult-sppifo/rx_pkt_id.png', 'MyResult-0505-pifo1000-weight1-10/rx_log/']
    ...
    #fig_title = 'PCQ'
    sche = ['MyResult-0508-reno-sppifo-8-128-nosack/rx_pkt_id_line.png', 'MyResult-0508-reno-sppifo-8-128-nosack/rx_log/']
    fig_title = 'with SACK'
    ...
    plt.scatter(xs[0], ys[0], s=1, label = labels[0])
    #plt.scatter(xs[0], y_ideal, s=1, label = "ideal", color="green", alpha=0.01)

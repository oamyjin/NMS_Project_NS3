...
main(int argc, char* argv[])
{
    ...
    {
        p2p[i].SetDeviceAttribute("DataRate", StringValue("100Mbps"));
    ...
    p2p[clientNum].SetDeviceAttribute("DataRate", StringValue("100Mbps"));
    ...
    Time interPacketInterval = Seconds(0.000546);//15Mbps

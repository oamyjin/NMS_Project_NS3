...
main(int argc, char* argv[])
{
    ...
    std::cout << "TcpDctcp" << std::endl;
    bool enableSwitchEcn = true;
    Config::SetDefault("ns3::TcpSocketBase::Sack", BooleanValue(true));
    std::string qdiscTypeId = "ns3::RedQueueDisc"; //"ns3::SppifoQueueDisc" "ns3::FifoQueueDisc" "ns3::PifoQueueDisc" "ns3::AFQQueueDisc"
    Config::SetDefault(qdiscTypeId + "::MaxSize", QueueSizeValue(QueueSize("84p"))); // 2666p

    // TcpNewReno
    // std::string tcpTypeId = "TcpNewReno"; 
    // std::cout << "TcpNewReno" << std::endl;
    ...
    // Config::SetDefault(qdiscTypeId + "::MaxSize", QueueSizeValue(QueueSize("128p"))); // 2666p

    // TcpCubic
    // std::string tcpTypeId = "TcpCubic"; 
    // std::cout << "TcpCubic" << std::endl;
    // bool enableSwitchEcn = false;
    // std::string qdiscTypeId = "ns3::PifoQueueDisc"; //"ns3::SppifoQueueDisc" "ns3::FifoQueueDisc" "ns3::PifoQueueDisc" "ns3::AFQQueueDisc"
    // Config::SetDefault(qdiscTypeId + "::MaxSize", QueueSizeValue(QueueSize("2666p"))); // 2666p

    // TcpBbr
    // std::string tcpTypeId = "TcpBbr"; 
    // std::cout << "TcpBbr" << std::endl;
    // bool enableSwitchEcn = false;
    ...
    Config::SetDefault("ns3::RedQueueDisc::MaxSize", QueueSizeValue(QueueSize("84p")));
    ...
    //                           "MaxTh",
    //                           DoubleValue(150));
    tchRed10.SetRootQueueDisc(qdiscTypeId);
    ...
    //                          "MaxTh",
    //                          DoubleValue(60));
    tchRed1.SetRootQueueDisc(qdiscTypeId);
    ...
    rxS1R1Throughput.open("MyResult/dctcp-example-s1-r1-throughput.dat", std::ios::out);
    rxS1R1Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
    rxS2R2Throughput.open("MyResult/dctcp-example-s2-r2-throughput.dat", std::ios::out);
    rxS2R2Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
    rxS3R1Throughput.open("MyResult/dctcp-example-s3-r1-throughput.dat", std::ios::out);
    rxS3R1Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
    fairnessIndex.open("MyResult/dctcp-example-fairness.dat", std::ios::out);
    t1QueueLength.open("MyResult/dctcp-example-t1-length.dat", std::ios::out);
    t1QueueLength << "#Time(s) qlen(pkts) qlen(us)" << std::endl;
    t2QueueLength.open("MyResult/dctcp-example-t2-length.dat", std::ios::out);

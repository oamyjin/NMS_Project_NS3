...
Time srcStartTime = Seconds(10.0);
Time dstStartTime = Seconds(0.0);
Time checkQSizeTimeInterval = Seconds(0.001);
...
main(int argc, char* argv[])
{
    ...
    std::string qdiscTypeId = "ns3::FifoQueueDisc"; //"ns3::SppifoQueueDisc" "ns3::FifoQueueDisc"
    bool isSack = true;
    uint32_t delAckCount = 0;
    std::string recovery = "ns3::TcpClassicRecovery";
    char const *p2pRouterRate = "1Mbps";
    char const *p2pRouterDelay = "10ms";
    char const *p2pLeafRate = "10Mbps";
    char const *p2pLeafDelay = "1ms";
    ...
    Config::SetDefault(qdiscTypeId + "::MaxSize", QueueSizeValue(QueueSize("30p")));

...
main(int argc, char* argv[])
{
    ...
    Config::SetDefault(qdiscTypeId + "::MaxSize", QueueSizeValue(QueueSize("1024p")));
    ...
    leftNodes.Get(1)->SetWeight(10);
    InstallBulkSend(leftNodes.Get(1),
                    routerToRightIPAddress[0].GetAddress(1),
                    port,
                    socketFactory,
                    3,
